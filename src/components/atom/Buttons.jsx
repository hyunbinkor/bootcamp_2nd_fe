...
const KakaoButton = () => {
  const handleLoginKakao = async () => {
    ...
    //   redirectUri
    // });
    window.location.href = `https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=c84840525d9cdbf1a8ba40a6b6f62089&redirect_uri=${import.meta.env.VITE_BASE_URL}/kakao`;
  };
  return (
